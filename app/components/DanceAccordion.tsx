...
export default function DanceAccordion({
  entry,
  isExpanded,
  onToggle,
  showDay = false,
  ...
  const dancers = entry.dancerName
    ...
    : [];
  const isGroupRoutine = dancers.length > 1;
          ...
          {isGroupRoutine ? (
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="flex items-center justify-center gap-2">
                <span className="text-xs text-gray-500">Dancer: </span>
