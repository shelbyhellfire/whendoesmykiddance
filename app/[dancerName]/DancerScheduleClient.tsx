                    ...
                    <React.Fragment key={index}>
                      <div className="border-2 border-gray-300 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-200">
                        <button
                          ...
                          className="w-full bg-cyan-600 hover:bg-cyan-700 text-white px-2 py-3 md:px-6 md:py-4 flex flex-wrap items-center gap-2 md:gap-3 transition-colors relative"
                        >
                          <h3
                            className={`flex-shrink-0 font-bold text-left whitespace-nowrap pr-8 ${
                              (entry.routineName || "").length > 30
                                ? "text-xs md:text-sm"
                                : (entry.routineName || "").length > 18
